    ...
    <main className="min-h-screen bg-[#faf8f6] flex flex-col justify-between">
      <div>
        ...
        <div className="mx-auto max-w-4xl px-6 py-16 lg:px-10 lg:py-24">
          ...
          <h1 className="font-serif text-4xl md:text-5xl text-[#38312d] mb-8">Aviso Legal</h1>
          <div className="prose prose-zinc max-w-none text-zinc-700 space-y-6 leading-relaxed">
            <section>
              <h2 className="font-serif text-2xl text-[#38312d] mb-3">1. Datos Identificativos</h2>
              <p>
                En cumplimiento con el deber de información recogido en el artículo 10 de la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y del Comercio Electrónico (LSSI-CE), se facilitan los siguientes datos informativos:
              </p>
              <ul className="list-disc pl-6 space-y-1 mt-2">
                <li><strong>Titular del sitio web:</strong> ML Mimo Mento Nails Studio</li>
                <li><strong>Dirección:</strong> Calle Pedro Guezala, 3, Local A 1, 38007 Santa Cruz de Tenerife</li>
                <li><strong>NIF:</strong> B-00000000 (en trámite)</li>
                <li><strong>Contacto:</strong> Presencial en nuestro estudio o a través de nuestras redes sociales oficiales.</li>
              </ul>
            </section>

            <section>
              <h2 className="font-serif text-2xl text-[#38312d] mb-3">2. Usuarios y Condiciones de Uso</h2>
              <p>
                El acceso y/o uso de este sitio web atribuye la condición de usuario, aceptando desde dicho acceso las presentes condiciones de uso. El sitio web proporciona acceso a información sobre los servicios de estética de uñas, gestión de reservas y ubicación de ML Mimo Mento Nails Studio.
              </p>
            </section>

            <section>
              <h2 className="font-serif text-2xl text-[#38312d] mb-3">3. Propiedad Intelectual e Industrial</h2>
              <p>
                ML Mimo Mento Nails Studio es titular de todos los derechos de propiedad intelectual e industrial de su página web, así como de los elementos contenidos en la misma (imágenes, logotipos, textos, marcas, combinaciones de colores, estructura y diseño). Queda expresamente prohibida la reproducción, distribución o transformación sin la autorización expresa y previa del titular.
              </p>
            </section>

            <section>
              <h2 className="font-serif text-2xl text-[#38312d] mb-3">4. Exclusión de Garantías y Responsabilidad</h2>
              <p>
                ML Mimo Mento Nails Studio no se hace responsable, en ningún caso, de los daños y perjuicios de cualquier naturaleza que pudieran ocasionar errores u omisiones en los contenidos, falta de disponibilidad del portal o la transmisión de virus o programas maliciosos, a pesar de haber adoptado todas las medidas tecnológicas necesarias para evitarlo.
              </p>
            </section>
          </div>
        </div>
